...
-- === PRIMARY COLORS ===
UIConstants.COLOR_PRIMARY = {0.2, 0.3, 0.5, 1}        -- Deep blue
UIConstants.COLOR_SECONDARY = {0.4, 0.4, 0.5, 1}      -- Neutral gray  
UIConstants.COLOR_ACCENT = {0.8, 0.6, 0.2, 1}         -- Golden yellow
